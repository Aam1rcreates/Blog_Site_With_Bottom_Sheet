...
const Main = ({ toggleSheet, isOpen }) => {
    return (
        <div className="container">
            <h1 className="text-dark py-5 text-center">
                <strong>Lorem ipsum dolor sit amet...</strong>
            </h1>
            <div className="container py-3 text-center">
                <div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" height="3em" viewBox="0 0 512 512"><path d="M399 384.2C376.9 345.8 335.4 320 288 320H224c-47.4 0-88.9 25.8-111 64.2c35.2 39.2 86.2 63.8 143 63.8s107.8-24.7 143-63.8zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm256 16a72 72 0 1 0 0-144 72 72 0 1 0 0 144z" /></svg>
                    </div>
                    <div>
                        <p>
                            <strong>Md Aamir Shekh </strong>
                            <span><a href="#default" style={{textDecoration: 'none'}}>Follow</a></span>
                        </p>
                    </div>
                    <div>
            ...
            <div className="text-center">
                <img src="https://www.typingpal.com/images/1/3/a/8/4/13a845e178cb05ecc149ffc850ad9a6eac19f85d-lorem-ipsum.png" alt="" className="img-fluid" />
            </div>
